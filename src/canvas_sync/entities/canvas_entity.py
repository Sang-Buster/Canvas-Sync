...
class CanvasEntity(object):
    def __init__(
        ...
        api          : object  | An Canvas-Sync InstructureApi object, should be the same object across the hierarchy during
                                 synchronization.
        settings     : object  | A Canvas-Sync Settings object, should be the same object across the hierarchy during
                                 synchronization.
        identifier   : string  | A string representing what derived class inherited from this instance of CanvasEntity
        synchronizer : object  | The Canvas-Sync Synchronizer object
        ...
        self.sync_path = helpers.get_corrected_path(
            sync_path, parent_path, folder=folder
        )
